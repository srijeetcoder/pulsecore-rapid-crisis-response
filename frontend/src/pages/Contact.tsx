import { Home, Mail, Phone, MapPin, Send, ShieldAlert } from 'lucide-react';
          ...
          <div className="card-terminal shadow-2xl relative overflow-hidden">
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div>
                  <label className="block font-mono text-[10px] font-bold text-stardust mb-3 uppercase tracking-widest">NAME</label>
                  <input type="text" className="input-terminal w-full" placeholder="Arjun" />
                </div>
                <div>
                  <label className="block font-mono text-[10px] font-bold text-stardust mb-3 uppercase tracking-widest">SURNAME</label>
                  <input type="text" className="input-terminal w-full" placeholder="Sharma" />
                </div>
              </div>
              <div>
                <label className="block font-mono text-[10px] font-bold text-stardust mb-3 uppercase tracking-widest">EMAIL ADDRESS</label>
